...
export class SmsService {
  ...
  async sendOtp(phone: string, otpCode: string): Promise<boolean> {
    ...
    try {
      ...
      if (this.route === 'dlt') {
        urlParams.append('message', `${otpCode}is your Haatza verification code.It is Valid for 5 minutes.Please do not share it with anyone.
          Regards,
          Haatza India Private Limited`);
